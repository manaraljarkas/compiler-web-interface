// Generated from c:/Users/DELL/Desktop/University/compiler/compiler-web-interface/grammar/Lexer_HTML_Jinja_CSS.g4 by ANTLR 4.13.1
...
public class Lexer_HTML_Jinja_CSS extends Lexer {
	...
	public static String[] modeNames = {
		"DEFAULT_MODE", "TAG", "JINJA", "CSS"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"LT", "JINJA_OPEN_EXPR", "JINJA_OPEN_STMT", "TEXT", "STYLE_OPEN", "STYLE_CLOSE", 
			"WS", "GT", "SLASH", "EQ", "TAG_IDENTIFIER", "STRING", "ATTR_VALUE", 
			"DOCTYPE", "TAG_WS", "JINJA_CLOSE_EXPR", "JINJA_CLOSE_STMT", "FOR", "IN", 
			"ENDFOR", "IF", "ENDIF", "NOT", "DOT", "JINJA_IDENTIFIER", "JINJA_WS", 
			"CSS_STYLE_CLOSE", "LEFT_CURLY", "RIGHT_CURLY", "COLON", "SEMICOLON", 
			"COMMA", "CSS_DOT", "COLOR", "UNIT", "NUMBERS", "CSS_STRING", "CHARACTERS", 
			"CSS_WS"
		};
	}
	...
	public Lexer_HTML_Jinja_CSS(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "Lexer_HTML_Jinja_CSS.g4"; }
