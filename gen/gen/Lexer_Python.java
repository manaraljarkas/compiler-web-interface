...
public class Lexer_Python extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INDENT", "DEDENT", "NEWLINE", "WS", "FROM", "IMPORT", "LOAD", "DEF", 
			"RETURN", "ROUTE", "INT", "FOR", "IN", "AS", "GET", "POST", "WITH", "OPEN", 
			"IMPORT_JSON", "IF", "IS", "IS_NOT", "EQUAL_EQUAL", "DEFAULT", "BREAK", 
			"COMMA", "EQUAL", "NOT_EQUAL", "OPEN_B", "CLOSE_B", "Colon", "AT", "DOT", 
			"LEFT_ANGLE", "RIGHT_ANGLE", "LEFT_ARRAY", "RIGHT_ARRAY", "LEFT_CURLY", 
			"RIGHT_CURLY", "PLUS", "MINUS", "MUL", "DIV", "PLUSEQUAL", "NUMBERS", 
			"CHARACTERS", "STRING"
		};
	}
